...
public final class SpecialistTypeMock {
    ...
    private static final class DefaultSpecialistTypeBuilder<T> extends DefaultBuilder<SpecialistType<T>, SpecialistTypeBuilder<T>, DefaultSpecialistTypeBuilder<T>> implements SpecialistTypeBuilder<T> {
