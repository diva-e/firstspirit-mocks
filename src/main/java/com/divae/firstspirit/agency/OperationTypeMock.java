...
public final class OperationTypeMock {
    ...
    private static final class DefaultOperationTypeBuilder<T> extends DefaultBuilder<OperationType<T>, OperationTypeBuilder<T>, DefaultOperationTypeBuilder<T>> implements OperationTypeBuilder<T> {
