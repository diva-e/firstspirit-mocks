...
public final class EntityInfoMock {
    ...
    private static final class DefaultEntityInfoBuilder extends DefaultBuilder<EntityInfo, EntityInfoBuilder, DefaultEntityInfoBuilder> implements EntityInfoBuilder {
