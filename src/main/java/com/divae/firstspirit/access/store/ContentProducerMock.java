...
public final class ContentProducerMock {
    ...
    private static final class TruncatedDefaultContentProducerBuilder<T extends ContentProducer> extends DefaultContentProducerBuilder<T, TruncatedContentProducerBuilder<T>, TruncatedDefaultContentProducerBuilder<T>> implements TruncatedContentProducerBuilder<T> {
        ...
        private <OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultContentProducerBuilder(String uid, long id, UidType uidType, OTBUILDER parent) {
            super(uid, id, uidType, parent);
        }

        private <OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultContentProducerBuilder(String uid, long id, UidType uidType, String extension, TemplateSetBuilder templateSet, OTBUILDER parent) {
