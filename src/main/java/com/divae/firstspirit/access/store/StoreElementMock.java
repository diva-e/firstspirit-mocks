...
public final class StoreElementMock {
	...
	private static final class DefaultTruncatedStoreElementBuilder<T extends StoreElement> extends DefaultStoreElementBuilder<T, TruncatedStoreElementBuilder<T>, DefaultTruncatedStoreElementBuilder<T>> implements TruncatedStoreElementBuilder<T> {
		...
		<OT extends StoreElement, OTBUILDER extends StoreElementBuilder<OT, OTBUILDER>> DefaultTruncatedStoreElementBuilder(String name, OTBUILDER parent) {
			super(name, parent);
		}

		<OTBUILDER extends StoreElementBuilder<T, OTBUILDER>> DefaultTruncatedStoreElementBuilder(OTBUILDER storeElement) {
			super(storeElement);
		}
	}
}