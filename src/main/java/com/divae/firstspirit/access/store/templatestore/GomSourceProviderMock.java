...
public final class GomSourceProviderMock {
	...
	private static final class TruncatedDefaultGomSourceProviderBuilder<T extends GomSourceProvider> extends DefaultGomSourceProviderBuilder<T, TruncatedGomSourceProviderBuilder<T>, TruncatedDefaultGomSourceProviderBuilder<T>> implements TruncatedGomSourceProviderBuilder<T> {
		...
		<OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultGomSourceProviderBuilder(String name, long id, OTBUILDER parent) {
			super(name, id, parent);
		}

		<OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultGomSourceProviderBuilder(String uid, long id, UidType uidType, OTBUILDER parent) {
			super(uid, id, uidType, parent);
		}

		<OTBUILDER extends GomSourceProviderBuilder<T, OTBUILDER>> TruncatedDefaultGomSourceProviderBuilder(OTBUILDER idProvider) {
			super(idProvider);
		}
	}
}
