...
public final class ContentFolderMock {
	...
	private static final class TruncatedDefaultContentFolderBuilder<T extends ContentFolder> extends DefaultContentFolderBuilder<T, TruncatedContentFolderBuilder<T>, TruncatedDefaultContentFolderBuilder<T>> implements TruncatedContentFolderBuilder<T> {
		...
		<OT extends ContentFolder, OTBUILDER extends ContentFolderBuilder<OT, OTBUILDER>> TruncatedDefaultContentFolderBuilder(String name, long id, OTBUILDER parent) {
			super(name, id, parent);
		}

		<OTUILDER extends ContentFolderBuilder<T, OTUILDER>> TruncatedDefaultContentFolderBuilder(OTUILDER contentFolder) {
			super(contentFolder);
		}
	}
}
