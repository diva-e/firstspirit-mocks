...
public final class PageMock {
	...
	private static final class TruncatedDefaultPageBuilder<T extends Page> extends DefaultPageBuilder<T, TruncatedPageBuilder<T>, TruncatedDefaultPageBuilder<T>> implements TruncatedPageBuilder<T> {
		...
		<OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultPageBuilder(String uid, long id, UidType uidType, OTBUILDER parent) {
			super(uid, id, uidType, parent);
		}

		<OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultPageBuilder(String uid, long id, UidType uidType, String extension, TemplateSetBuilder templateSet, OTBUILDER parent) {
			super(uid, id, uidType, extension, templateSet, parent);
		}
	}
}
