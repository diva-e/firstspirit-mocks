...
public final class MediaFolderMock {
	...
	private static final class TruncatedDefaultMediaFolderBuilder<T extends MediaFolder> extends DefaultMediaFolderBuilder<T, TruncatedMediaFolderBuilder<T>, TruncatedDefaultMediaFolderBuilder<T>> implements TruncatedMediaFolderBuilder<T> {
		...
		<OT extends MediaFolder, OTBUILDER extends MediaFolderBuilder<OT, OTBUILDER>> TruncatedDefaultMediaFolderBuilder(String uid, long id, OTBUILDER parent) {
			super(uid, id, parent);
		}

		<OTUILDER extends MediaFolderBuilder<T, OTUILDER>> TruncatedDefaultMediaFolderBuilder(OTUILDER mediaFolder) {
			super(mediaFolder);
		}
	}
}
