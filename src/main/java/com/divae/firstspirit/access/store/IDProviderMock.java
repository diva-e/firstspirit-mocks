...
public final class IDProviderMock {
	...
	private static final class DefaultTruncatedIDProviderBuilder<T extends IDProvider> extends DefaultIDProviderBuilder<T, TruncatedIDProviderBuilder<T>, DefaultTruncatedIDProviderBuilder<T>> implements TruncatedIDProviderBuilder<T> {
		...
		<OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> DefaultTruncatedIDProviderBuilder(String name, long id, OTBUILDER parent) {
			super(name, id, parent);
		}

		<OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> DefaultTruncatedIDProviderBuilder(String uid, long id, UidType uidType, OTBUILDER parent) {
			super(uid, id, uidType, parent);

		}

		<OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> DefaultTruncatedIDProviderBuilder(String uid, long id, UidType uidType, OTBUILDER parent, ProjectBuilder project) {
			super(uid, id, uidType, parent, project);
		}

		<OTBUILDER extends IDProviderBuilder<T, OTBUILDER>> DefaultTruncatedIDProviderBuilder(OTBUILDER idProvider) {
			super(idProvider);
		}
