...
public final class BodyMock {
    ...
    private static final class TruncatedDefaultBodyBuilder<T extends Body> extends DefaultBodyBuilder<T, TruncatedBodyBuilder<T>, TruncatedDefaultBodyBuilder<T>> implements TruncatedBodyBuilder<T> {
        ...
        private <OT extends Page, OTBUILDER extends PageBuilder<OT, OTBUILDER>> TruncatedDefaultBodyBuilder(String uid, long id, UidType uidType, OTBUILDER parent) {
            super(uid, id, uidType, parent);
        }

        private <OT extends Page, OTBUILDER extends PageBuilder<OT, OTBUILDER>> TruncatedDefaultBodyBuilder(String name, long id, OTBUILDER parent) {
            super(name, id, parent);
        }
    }
}
