...
public final class DataProviderMock {
    ...
    private static final class TruncatedDefaultDataProviderBuilder<T extends DataProvider> extends DefaultDataProviderBuilder<T, TruncatedDataProviderBuilder<T>, TruncatedDefaultDataProviderBuilder<T>> implements TruncatedDataProviderBuilder<T> {
        ...
        private <OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultDataProviderBuilder(String name, long id, OTBUILDER parent) {
            super(name, id, parent);
        }

        private <OT extends IDProvider, OTBUILDER extends IDProviderBuilder<OT, OTBUILDER>> TruncatedDefaultDataProviderBuilder(String uid, long id, UidType uidType, OTBUILDER parent) {
            super(uid, id, uidType, parent);
        }

        private <OTBUILDER extends DataProviderBuilder<T, OTBUILDER>> TruncatedDefaultDataProviderBuilder(OTBUILDER builder) {
            super(builder);
        }
    }
}
