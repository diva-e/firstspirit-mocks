...
import static de.espirit.firstspirit.access.ReferenceEntry.*;
...
public final class ReferenceEntryMock {
	...
	public interface ReferenceEntryBuilder extends Builder<ReferenceEntry, ReferenceEntryBuilder> {
		...
		ReferenceEntryBuilder aReferencedElement(MediaFolderBuilder mediaFolder);
		...
		ReferenceEntryBuilder aReferencedElement(PageFolderBuilder pageFolder);
	...
	public static final class DefaultReferenceEntryBuilder extends DefaultBuilder<ReferenceEntry, ReferenceEntryBuilder, DefaultReferenceEntryBuilder> implements ReferenceEntryBuilder {
		...
		@Override
		public final ReferenceEntryBuilder aReferencedElement(MediaFolderBuilder mediaFolder) {
		...
		@Override
		public final ReferenceEntryBuilder aReferencedElement(PageFolderBuilder pageFolder) {
